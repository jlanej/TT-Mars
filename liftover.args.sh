...
python $script_dir/trim_overlapping_contigs.py assem1_sort.bam $output_dir $if_hg38
python $script_dir/trim_overlapping_contigs.py assem2_sort.bam $output_dir $if_hg38
...
python $script_dir/lo_assem_to_ref.py $output_dir $output_dir/assem1_nool_sort.bam $output_dir/assem2_nool_sort.bam
...
python $script_dir/lo_assem_to_ref_0.py $output_dir $output_dir/assem1_nool_sort.bam $output_dir/assem2_nool_sort.bam
...
python $script_dir/compress_liftover.py $output_dir lo_pos_assem1_result.bed lo_pos_assem1_result_compressed.bed
python $script_dir/compress_liftover.py $output_dir lo_pos_assem2_result.bed lo_pos_assem2_result_compressed.bed
python $script_dir/compress_liftover.py $output_dir lo_pos_assem1_0_result.bed lo_pos_assem1_0_result_compressed.bed
python $script_dir/compress_liftover.py $output_dir lo_pos_assem2_0_result.bed lo_pos_assem2_0_result_compressed.bed

#######################################################
#######################################################
#5. Get non-covered regions

python $script_dir/get_conf_int.py $output_dir $output_dir/assem1_nool_sort.bam $output_dir/assem2_nool_sort.bam $if_hg38
